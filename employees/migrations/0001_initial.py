    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='Employee ID')),
                ('department', models.CharField(blank=True, max_length=100, null=True, verbose_name='Department/division')),
                ...
                ('employment_status', models.CharField(blank=True, choices=[('--Select--', '--Select--'), ('Full-time', 'Full-time'), ('Part-time', 'Part-time'), ('Contract', 'Contract'), ('Intern', 'Intern'), ('Volunteer', 'Volunteer'), ('Temporary', 'Temporary'), ('Seasonal', 'Seasonal'), ('Freelance', 'Freelance'), ('Remote', 'Remote'), ('Disabled', 'Disabled'), ('Other', 'Other')], max_length=20, null=True, verbose_name='Employment status')),
                ...
                ('next_of_kin_relationship', models.CharField(blank=True, max_length=100, null=True, verbose_name='Next of kin relationship')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=True, help_text='Can log into admin site', verbose_name='is staff')),
