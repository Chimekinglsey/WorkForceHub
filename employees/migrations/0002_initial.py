...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='branch',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admin_user', to='organizations.branch'),
        ),
        migrations.AddField(
            model_name='adminuser',
            name='groups',
        ...
        migrations.AddField(
            model_name='employee',
            name='branch',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employee', to='organizations.branch'),
        ),
        migrations.AddField(
            model_name='employee',
            name='supervised_employees',
